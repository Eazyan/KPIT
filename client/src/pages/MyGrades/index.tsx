                ...
                >
                  ...
                  <Box sx={{ width: '15%', display: 'flex', justifyContent: 'flex-end' }}>
                    <Box sx={{ 
                      ...
                      height: '36px',
                      borderRadius: '50%',
                      backgroundColor: Number(grade.value) >= 4 ? '#4CAF50' : Number(grade.value) >= 3 ? '#FF9800' : '#F44336',
                      color: 'white',
                      fontWeight: 'bold'
                    }}>
                      {grade.value}
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Box sx={{ 
                              ...
                              height: '24px',
                              borderRadius: '50%',
                              backgroundColor: avgGrade >= 4 ? '#4CAF50' : avgGrade >= 3 ? '#FF9800' : '#F44336',
                              color: 'white',
                              fontWeight: 'bold',
                              fontSize: '0.75rem'
                            }}>
