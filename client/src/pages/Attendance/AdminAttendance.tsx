...
const AdminAttendance: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSubjects = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await api.get(`/api/subjects/by-group/${selectedGroup}`);
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await api.get(`/api/students/by-group/${selectedGroup}`);
  ...
  useEffect(() => {
    const fetchAttendanceData = async () => {
      ...
      try {
        setIsLoading(true);
        let url = `/api/attendance/analytics`;
        const params = {
